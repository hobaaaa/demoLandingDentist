...
import { PsychologistVariantTwoRedesign } from "@/components/psychologist/psychologist-variant-redesigns";
...
export async function generateMetadata({
  ...
  return {
    title: `${demo.seoTitle} | Tasarım V2`,
...
export default async function PsychologistVariantTwoRoute({
  params,
  ...
  return <PsychologistVariantTwoRedesign demo={demo} />;
}
